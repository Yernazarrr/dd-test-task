...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SpecialtyDto&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
...
@override
String toString() {
  return 'SpecialtyDto(id: $id, name: $name)';
}
...
class _SpecialtyDto implements SpecialtyDto {
  const _SpecialtyDto({required this.id, required this.name});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SpecialtyDto&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
